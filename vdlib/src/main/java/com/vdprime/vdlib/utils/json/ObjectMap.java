...
public class ObjectMap<K, V> implements Iterable<ObjectMap.Entry<K, V>>
{
    ...
    private void push(
            K insertKey, V insertValue, int index1, K key1, int index2, K key2, int index3, K key3
    )
    {
        K[] keyTable   = this.keyTable;
    ...
    public void ensureCapacity(int additionalCapacity)
    {
        ...
        { resize(nextPowerOfTwo((int) Math.ceil(sizeNeeded / loadFactor))); }
    }
    ...
    static public class Values<V> extends MapIterator<Object, V, V>
    {
        ...
        {
            return toArray(new ArrayList<V>(map.size));
        }
        
        /** Adds the remaining values to the specified array. */
        public List<V> toArray(List<V> array)
        {
    ...
    static public class Keys<K> extends MapIterator<K, Object, K>
    {
        ...
        {
            return toArray(new ArrayList<K>(map.size));
        }
        
        /** Adds the remaining keys to the array. */
        public List<K> toArray(List<K> array)
        {
            while (hasNext) array.add(next());
            return array;
        }
