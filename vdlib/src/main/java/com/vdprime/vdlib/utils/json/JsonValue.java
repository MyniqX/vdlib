...
import com.vdprime.vdlib.utils.json.Json.SerializationException;
        ...
        for (JsonValue value = child; value != null; value = value.next, i++)
        {
            ...
            switch (value.type)
            {
                ...
                case booleanValue:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Value cannot be converted to float: " +
                                                    value.type);
            }
            array[i] = v;
        }
        ...
        for (JsonValue value = child; value != null; value = value.next, i++)
        {
            ...
            switch (value.type)
            {
                ...
                case booleanValue:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Value cannot be converted to long: " +
                                                    value.type);
            }
            array[i] = v;
        }
        ...
        for (JsonValue value = child; value != null; value = value.next, i++)
        {
            ...
            switch (value.type)
            {
                ...
                case booleanValue:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Value cannot be converted to byte: " +
                                                    value.type);
            }
            array[i] = v;
        }
        ...
        for (JsonValue value = child; value != null; value = value.next, i++)
        {
            ...
            switch (value.type)
            {
                ...
                case booleanValue:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Value cannot be converted to short: " +
                                                    value.type);
            }
            array[i] = v;
        }
        ...
        for (JsonValue value = child; value != null; value = value.next, i++)
        {
            ...
            switch (value.type)
            {
                ...
                case booleanValue:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Value cannot be converted to char: " +
                                                    value.type);
            }
            array[i] = v;
        }
